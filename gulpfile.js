...
elixir(function(mix) {
    ...
    // Combine article_system scripts
    mix.scripts([
        'js/jquery.js',
        'js/bootstrap.js',
        'js/article_system.js'
    ], 'public/assets/js/article_system.js', 'resources//assets');

    // Compile CSS
    mix.less('admin.less', 'public/assets/css/admin.css');
    mix.less('article_system.less', 'public/assets/css/article_system.css');
});